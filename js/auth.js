...
formularioLogin.addEventListener('submit', (e)=>{//capturamos el evento
    ...
    const usuario = document.querySelector('#login-usuario').value; //Creacmos una constante el cual obtendra el valor de la caja de texto Usuario
    const password = document.querySelector('#login-password').value; //Creacmos una constante el cual obtendra el valor de la caja de texto Password
